<?php /* Smarty version Smarty-3.0.7, created on 2013-01-17 14:35:46
         compiled from "Y:\domains\oc//design/Opti-Class/html\order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1292950f7e212bfa9a4-81718184%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c649f36d466d7ea6fa3bc5a5253f529ba82076f' => 
    array (
      0 => 'Y:\\domains\\oc//design/Opti-Class/html\\order.tpl',
      1 => 1358422544,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1292950f7e212bfa9a4-81718184',
  'function' => 
  array (
  ),
...
<?php }?>
<?php if ($_smarty_tpl->getVariable('order')->value->coupon_discount>0){?>
<tr>
	<th class="image"></th>
	...
	<th class="amount"></th>
	<th class="price">
		&minus;<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['convert'][0][0]->convert($_smarty_tpl->getVariable('order')->value->coupon_discount);?>
&nbsp;<?php echo $_smarty_tpl->getVariable('currency')->value->sign;?>
...
<table class="order_info">
	<tr>
		...
		<td>
			<?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('order')->value->date,"%d.%m.%y в %H:%M");?>
...
<?php if ($_smarty_tpl->getVariable('payment_methods')->value&&!$_smarty_tpl->getVariable('payment_method')->value&&$_smarty_tpl->getVariable('order')->value->total_price>0){?>
<form method="post">
...
<?php }elseif($_smarty_tpl->getVariable('payment_method')->value){?>
    <h2>Способ оплаты &mdash; <?php echo $_smarty_tpl->getVariable('payment_method')->value->name;?>
        ...
        <form method=post style="margin-top:15px;font-size:20px;">
