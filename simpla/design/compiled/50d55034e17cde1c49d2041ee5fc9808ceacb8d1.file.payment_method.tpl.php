<?php /* Smarty version Smarty-3.0.7, created on 2012-12-24 15:17:29
         compiled from "simpla/design/html\payment_method.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1620950d847d93b4bc8-11783432%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50d55034e17cde1c49d2041ee5fc9808ceacb8d1' => 
    array (
  ...
  'nocache_hash' => '1620950d847d93b4bc8-11783432',
  'function' => 
  array (
  ),
...
<div class="message message_error">
	<span><?php if ($_smarty_tpl->getVariable('message_success')->value=='added'){?>Способ оплаты добавлен<?php }elseif($_smarty_tpl->getVariable('message_success')->value=='updated'){?>Способ оплаты изменен<?php }?></span>
...
' <?php if ($_smarty_tpl->getVariable('option')->value->value==$_smarty_tpl->getVariable('payment_settings')->value[$_smarty_tpl->getVariable('setting')->value->variable]){?>selected<?php }?>><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('option')->value->name);?>
				...
				<li><label class="property" for="<?php echo $_smarty_tpl->getVariable('setting')->value->variable;?>
"><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('setting')->value->name);?>
...
" id="<?php echo $_smarty_tpl->getVariable('setting')->value->variable;?>
"/></li>
				<?php }?>
			<?php }} ?>
			</ul>
