<?php /* Smarty version Smarty-3.0.7, created on 2012-12-24 15:34:32
         compiled from "simpla/design/html\order.tpl" */ ?>
<?php /*%%SmartyHeaderCode:604550d84bd869c3c2-70546942%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95a3a5105f3775b33ec16f3bcee6d9104d93f319' => 
    array (
  ...
  'nocache_hash' => '604550d84bd869c3c2-70546942',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_math')) include 'Y:\domains\oc\Smarty\libs\plugins\function.math.php';
?><?php ob_start(); ?>
...
<?php }else{ ?>Новый заказ<?php }?>
	...
	<a href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0][0]->url_modifier(array('view'=>'print'),$_smarty_tpl);?>
...
' value=''><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('purchase')->value->variant_name);?>
 <?php if ($_smarty_tpl->getVariable('purchase')->value->sku){?>(арт. <?php echo $_smarty_tpl->getVariable('purchase')->value->sku;?>
)<?php }?></option><?php }?>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['amounts']['max'] = (int)$_smarty_tpl->getVariable('settings')->value->max_order_amount;
...
'> <span class=currency>%</span>		
	...
	С учетом скидки<b> <?php echo round(($_smarty_tpl->getVariable('subtotal')->value-$_smarty_tpl->getVariable('subtotal')->value*$_smarty_tpl->getVariable('order')->value->discount/100),2);?>
 <?php echo $_smarty_tpl->getVariable('currency')->value->sign;?>
</b>
	</div> 
	
	<div class="block discount layer">
		<h2>Купон<?php if ($_smarty_tpl->getVariable('order')->value->coupon_code){?> (<?php echo $_smarty_tpl->getVariable('order')->value->coupon_code;?>
)<?php }?></h2>
		<input type=text name=coupon_discount value='<?php echo $_smarty_tpl->getVariable('order')->value->coupon_discount;?>
'> <span class=currency><?php echo $_smarty_tpl->getVariable('currency')->value->sign;?>
</span>		
	</div>

	<div class="subtotal layer">
	С учетом купона<b> <?php echo round(($_smarty_tpl->getVariable('subtotal')->value-$_smarty_tpl->getVariable('subtotal')->value*$_smarty_tpl->getVariable('order')->value->discount/100-$_smarty_tpl->getVariable('order')->value->coupon_discount),2);?>
 <?php echo $_smarty_tpl->getVariable('currency')->value->sign;?>
</b>
	</div> 
