<?php /* Smarty version Smarty-3.0.7, created on 2012-12-28 14:56:41
         compiled from "simpla/design/html\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:191650dd88f9805754-33189905%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ddd06a1ec013f4655541505a80113960ca0f6b3b' => 
    array (
  ...
  'nocache_hash' => '191650dd88f9805754-33189905',
  'function' => 
  array (
    'category_select' => 
    array (
...
"/> 
        ...
        <div class="checkbox">
            <input name="notbuy" value="1" type="checkbox" id="not_buy" <?php if ($_smarty_tpl->getVariable('product')->value->notbuy){?>checked<?php }?>/> <label for="not_buy">Нельзя купить</label>
        </div>
	</div> 
