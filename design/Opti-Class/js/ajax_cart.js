...
$('form.variants').live('submit', function(e) {
	...
	var o1 = $(this).offset();
	var o2 = $('.cart').offset();
    //alert('button-left '+o1.left+' button-top '+o1.top+'; cart-left '+o2.left+' cart-top '+o2.top);
	var dx = parseInt(o1.left) - parseInt(o2.left);
	var dy = parseInt(o1.top) - parseInt(o2.top);
